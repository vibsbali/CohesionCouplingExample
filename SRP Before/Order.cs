...
using EcommerceProjectBefore.Models;
using EcommerceProjectBefore.Services;
using EcommerceProjectBefore.Utility;

namespace EcommerceProjectBefore
{
    public class Order
    {
        public void Checkout(Cart cart, PaymentDetails paymentDetails, Customer customer, bool notifyCustomer)
        {
